 ...
 * @author ADMIN
 */
public class ThongkeTongthu extends javax.swing.JPanel {
    ...
    private void loadThongKeLoiNhuan() {
        DefaultTableModel model = (DefaultTableModel) tblThongke.getModel();
        model.setRowCount(0);
        String chuoi = (String) cboYear.getSelectedItem();
        int Nam = Integer.parseInt(chuoi);
        List<Object[]> list = DAO.getThongKeloiNhuan(Nam);
        for (Object[] objects : list) {
            BigDecimal bigDecimalValue = (BigDecimal) objects[1];
            double gia = bigDecimalValue.doubleValue();

            objects[1] = Utility.UtilityFormat.DinhdangVnd(gia);
    ...
    private void exportToExcel(String path) {
        try {
            ...
            WritableWorkbook workbook = Workbook.createWorkbook(new File(path + "\\ThongKeLoiNhuan.xls"));
            WritableSheet sheet = workbook.createSheet("ThongKeLoiNhuan", 0);
    ...
    private void createBarChart() {
        ...
        for (int i = 0; i < tblThongke.getRowCount(); i++) {
            ...
            float loiNhuan = Utility.UtilityFormat.DinhdangVndToFloat(tblThongke.getValueAt(i, 1).toString()); // Lợi nhuận

            dataset.addValue(loiNhuan, "Lợi nhuận", label);
        }

        JFreeChart barChart = ChartFactory.createBarChart(
                "Biểu đồ lợi nhuận theo tháng", // Tiêu đề biểu đồ
                "Tháng", // Nhãn trục x
                "Lợi nhuận", // Nhãn trục y
                dataset, // Dataset
    ...
    private void initComponents() {
        ...
        tblThongke.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tháng ", "Tổng thu", "Số lượng đã bán", "Xe đã bán", "Phụ kiện đã bán"
            }
        ));
