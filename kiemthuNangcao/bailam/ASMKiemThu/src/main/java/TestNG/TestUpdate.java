...
public class TestUpdate {
	...
	private void readDataFromExcel() {
		try {
			...
			worksheet = workbook.getSheet("TestUpdate");
			if (worksheet == null) {
	...
	public void suiteTest() {
		try {
			...
			TestNGResults.put("1", new Object[] { "STT", "Username", "Password", "Fullname", "Email", "Action",
					"Expected", "Actual", "Status", "Data Check" });
...
//							new Object[] { String.valueOf(index), username, password, fullname, email, "Test Insert",
...
//		} catch (Exception e) {
//			// TODO: handle exception
//			System.out.println("Insert Test(): " + e.getMessage());
//		}
//	}
	...
	public void UpdateTest() {
		try {
			...
			for (String key : keySet) {
				...
				driver.findElement(By.name("email")).sendKeys(email);
				Thread.sleep(1000);
				WebElement btnUpdate = driver.findElement(By.name("update"));
			...
			// TODO: handle exception
			System.out.println("Update Test(): " + e.getMessage());
		}
	}
	...
	public void suiteTearDown() {
		...
		for (String key : keySet) {
			...
			try {
				FileOutputStream out = new FileOutputStream(new File(excelDir + "RESULT_TEST_Update.xlsx"));
				workbook.write(out);
				out.close();
