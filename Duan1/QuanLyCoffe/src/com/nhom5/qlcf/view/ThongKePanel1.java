...
public class ThongKePanel1 extends javax.swing.JPanel {

    /**
     * Creates new form ThongKePanel
     */
    public ThongKePanel1() {
        initComponents();
        fillComboboxNam();
        fillComboboxThang();
        fillTableDoanhThu();
    ...
    void fillTableDoanhThu() {
        try {
            ...
            model.setRowCount(0);
            int nam = (Integer) cboxThongKeTheoNam.getSelectedItem();
            int thang = (Integer) cboxThongKeTheoThang.getSelectedItem();
    ...
    private void chooseDirectoryToSave(Workbook workbook) {
        ...
        if (x == JFileChooser.APPROVE_OPTION) {
            try {
                ...
                Logger.getLogger(ThongKePanel1.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        cboxThongKeTheoThang = new javax.swing.JComboBox<>();
        jLabel3 = new javax.swing.JLabel();
        cboxThongKeTheoNam = new javax.swing.JComboBox<>();
        ...
        cboxThongKeTheoThang.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboxThongKeTheoThangActionPerformed(evt);
            }
        });
        ...
        cboxThongKeTheoNam.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboxThongKeTheoNamActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(cboxThongKeTheoThang, javax.swing.GroupLayout.PREFERRED_SIZE, 297, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(111, 111, 111)
                        .addComponent(jLabel3)
                        .addGap(18, 18, 18)
                        .addComponent(cboxThongKeTheoNam, javax.swing.GroupLayout.PREFERRED_SIZE, 367, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(cboxThongKeTheoThang, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3)
                    .addComponent(cboxThongKeTheoNam, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
    ...
    private void cboxThongKeTheoNamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboxThongKeTheoNamActionPerformed
        fillTableDoanhThu();
    }//GEN-LAST:event_cboxThongKeTheoNamActionPerformed

    private void cboxThongKeTheoThangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboxThongKeTheoThangActionPerformed
        fillTableDoanhThu();
    }//GEN-LAST:event_cboxThongKeTheoThangActionPerformed
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
            ...
            Logger.getLogger(ThongKePanel1.class.getName()).log(Level.INFO,
    ...
    private javax.swing.JComboBox<String> cboxThongKeTheoNam;
    private javax.swing.JComboBox<String> cboxThongKeTheoThang;
